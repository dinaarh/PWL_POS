        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-sm table-bordered table-striped table-hover">
                    ...
                    <tr>
                        <th class="text-left col-3">Kode Barang: </th>
                        <td class="col-9">{{ $barang->barang_kode }}</td>
                    </tr>
                    <tr>
                        <th class="text-left col-3">Nama Barang: </th>
                        <td class="col-9">{{ $barang->barang_nama }}</td>
                    </tr>
                    <tr>
                        <th class="text-left col-3">Kategori Barang: </th>
                        <td class="col-9">{{ $barang->kategori->kategori_nama }}</td>
                    </tr>
                    <tr>
                        <th class="text-left col-3">Harga Beli: </th>
                        <td class="col-9">{{ $barang->harga_beli }}</td>
                    </tr>
                    <tr>
                        <th class="text-left col-3">Harga Jual: </th>
