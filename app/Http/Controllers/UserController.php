...
class UserController extends Controller
{
    ...
    {
        $request->validate([
            //username harus diisi, berupa string, minim 3 karakter
            ...
            'password' => 'nullable|min:5',      //password minim 5 karakter bisa tidak diisi
            'level_id' => 'required|integer'     //level_id harus diisi berupa angka
        ]);
    ...
    public function destroy(string $id)
    {
        ...
        try {
            UserModel::destroy($id); // Hapus data berdasar id
